...
namespace FCSPlayout.MediaFileImporter
{
    ...
    public partial class PlaySlider2 : UserControl
    {
        ...
        public static readonly DependencyProperty OutPositionProperty =
            DependencyProperty.Register("OutPosition", typeof(double), typeof(PlaySlider2), 
        ...
        public static readonly DependencyProperty InPositionProperty =
            DependencyProperty.Register("InPosition", typeof(double), typeof(PlaySlider2), 
        ...
        {
            ((PlaySlider2)dpObj).OnInPositionChanged((double)e.OldValue, (double)e.NewValue);
        }

        private static void OnOutPositionPropertyChanged(DependencyObject dpObj, DependencyPropertyChangedEventArgs e)
        {
            ((PlaySlider2)dpObj).OnOutPositionChanged((double)e.OldValue, (double)e.NewValue);
        }
