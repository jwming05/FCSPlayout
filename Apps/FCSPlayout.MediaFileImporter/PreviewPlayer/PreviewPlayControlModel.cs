...
{
    public partial class PreviewPlayControlModel : BindableBase
    {
        ...
        public PreviewPlayControlModel(MPlaylistSettings mplaylistSettings, IEventAggregator eventAggregator)
        {
